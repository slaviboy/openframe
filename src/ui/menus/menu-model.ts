...
const MAIN_MENU: readonly (readonly [string, readonly (readonly string[])[]])[] = [
  ['File', [['file.browse', 'file.open', 'file.save', 'file.saveAs', 'file.saveLocalCopy'], ['file.showVersionHistory'], ['file.export'], ['file.colorProfileSrgb', 'file.colorProfileP3']]],
  [
    'Edit',
    [
      ['edit.undo', 'edit.redo'],
  ...
  [
    ...
    [
      ...
      [
        ...
        'object.combineAsVariants',
        'object.addVariant',
        'object.convertToSlot',
        'object.wrapInNewSlot',
        'object.detachInstance',
        'object.resetOverrides',
        'object.goToMainComponent',
        'object.restoreMainComponent',
        'object.pushChangesToMain',
      ],
  ...
  [
    ...
    [
      ...
      ['text.bulletedList', 'text.numberedList', 'text.createLink'],
      ['text.directionLtr', 'text.directionRtl'],
    ],
  ],
  [
    'Arrange',
  ...
  return [
    {
      ...
      id: 'select-layer',
      label: 'Select layer',
      entries: layers.map((id): MenuEntry => ({
        kind: 'item',
        id: `select-layer-${id}`,
