...
| `VARIABLE_COLLECTION` | A variable collection, a child of the document root: `modes` (1–40 `{modeId, name}`; the first is the default mode). Its children are its variables, in order. |
